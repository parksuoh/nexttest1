...
const CustomEditor2 = () => {
  ...
  return (
    <div className='flex flex-col w-full min-h-screen'>
        ...
        <div className='flex justify-between'>
            <button
                onClick={() => {
                    ...
                    // let sembed = '<imgsrc="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5A6LmUMUwUH_sSSaweGjDjJ1LrnDleVe1B8qOoGXa2A&s"></img>'
        ...
        <div
            className='block w-full bg-slate-50 p-5' 
            contentEditable
